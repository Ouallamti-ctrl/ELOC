...
// ─── PERSISTENT FILE STORE (localStorage) ────────────────────────────────────
// Files are stored as base64 dataURLs in localStorage so they survive page
// reloads. Key format: "eloc_file_<id>"
const FILE_STORE = {}; // in-memory cache to avoid repeated JSON.parse

const LS_PREFIX = "eloc_file_";
  ...
  try {
    for (let i = 0; i < localStorage.length; i++) {
      ...
      if (k && k.startsWith(LS_PREFIX)) {
        ...
        FILE_STORE[id] = JSON.parse(localStorage.getItem(k));
      }
    }
  } catch(e) { /* localStorage may be unavailable in some sandboxes */ }
})();

let fileIdCounter = 1000 + Object.keys(FILE_STORE).length;

const storeFile = (file) => new Promise((resolve) => {
  const id = "file-" + (++fileIdCounter);
  const reader = new FileReader();
  reader.onload = (e) => {
    const entry = { name: file.name, type: file.type, dataUrl: e.target.result, size: file.size };
    FILE_STORE[id] = entry;
    try { localStorage.setItem(LS_PREFIX + id, JSON.stringify(entry)); } catch(e) {}
    resolve(id);
  };
...
const getFile = (id) => {
  if (!id) return null;
  if (FILE_STORE[id]) return FILE_STORE[id];
  // lazy load from localStorage if somehow not in cache
  try {
    const raw = localStorage.getItem(LS_PREFIX + id);
    if (raw) { FILE_STORE[id] = JSON.parse(raw); return FILE_STORE[id]; }
  } catch(e) {}
  return null;
};
...
const initialData = {
  users: [
    { id: 1, name: "Sarah Mitchell", email: "admin@eloc.com", password: "admin123", role: "admin", avatar: "SM" },
    { id: 2, name: "James Carter", email: "james@eloc.com", password: "teacher123", role: "teacher", phone: "+1 555-0102", commission: 35, salaryType: "commission", status: "active", avatar: "JC" },
    { id: 3, name: "Amelia Torres", email: "amelia@eloc.com", password: "teacher123", role: "teacher", phone: "+1 555-0103", commission: 40, salaryType: "commission", status: "active", avatar: "AT" },
    { id: 4, name: "Lucas Kim", email: "lucas@eloc.com", password: "student123", role: "student", age: 22, city: "New York", phone: "+1 555-0201", level: "B2", groupId: 1, registrationDate: "2024-09-01", paymentStatus: "paid", avatar: "LK" },
    { id: 5, name: "Priya Sharma", email: "priya@eloc.com", password: "student123", role: "student", age: 19, city: "Boston", phone: "+1 555-0202", level: "A2", groupId: 2, registrationDate: "2024-09-05", paymentStatus: "overdue", avatar: "PS" },
    { id: 6, name: "Omar Hassan", email: "omar@eloc.com", password: "student123", role: "student", age: 25, city: "Chicago", phone: "+1 555-0203", level: "B2", groupId: 1, registrationDate: "2024-08-20", paymentStatus: "paid", avatar: "OH" },
    { id: 7, name: "Elena Novak", email: "elena@eloc.com", password: "student123", role: "student", age: 21, city: "LA", phone: "+1 555-0204", level: "C1", groupId: 3, registrationDate: "2024-07-15", paymentStatus: "pending", avatar: "EN" },
  ],
  groups: [
    { id: 1, name: "B2 Morning", level: "B2", teacherId: 2, maxStudents: 12, schedule: "Mon/Wed/Fri 09:00–10:30", status: "active" },
    { id: 2, name: "A2 Evening", level: "A2", teacherId: 2, maxStudents: 10, schedule: "Tue/Thu 18:00–19:30", status: "active" },
    { id: 3, name: "C1 Advanced", level: "C1", teacherId: 3, maxStudents: 8, schedule: "Mon/Wed 11:00–12:30", status: "active" },
  ],
  sessions: buildInitialSessions(),
  series: [
    { id: SERIES_A, title: "Grammar & Speaking", groupId: 1, teacherId: 2, startDate: "2025-02-03", startTime: "09:00", endTime: "10:30", duration: 90, recurringDays: [1,3,5], endType: "date", endDate: "2025-06-30", paused: false },
    { id: SERIES_B, title: "A2 Evening Class", groupId: 2, teacherId: 2, startDate: "2025-02-04", startTime: "18:00", endTime: "19:30", duration: 90, recurringDays: [2,4], endType: "date", endDate: "2025-06-30", paused: false },
    { id: SERIES_C, title: "C1 Advanced Workshop", groupId: 3, teacherId: 3, startDate: "2025-02-03", startTime: "11:00", endTime: "12:30", duration: 90, recurringDays: [1,3], endType: "date", endDate: "2025-06-30", paused: false },
  ],
  payments: [
    { id: 1, studentId: 4, amount: 150, month: "February 2025", status: "paid", date: "2025-02-01", dueDate: "2025-02-05" },
    { id: 2, studentId: 5, amount: 120, month: "February 2025", status: "overdue", date: null, dueDate: "2025-02-05" },
    { id: 3, studentId: 6, amount: 150, month: "February 2025", status: "paid", date: "2025-02-03", dueDate: "2025-02-05" },
    { id: 4, studentId: 7, amount: 180, month: "February 2025", status: "pending", date: null, dueDate: "2025-02-28" },
    { id: 5, studentId: 4, amount: 150, month: "January 2025", status: "paid", date: "2025-01-02", dueDate: "2025-01-05" },
    { id: 6, studentId: 6, amount: 150, month: "January 2025", status: "paid", date: "2025-01-04", dueDate: "2025-01-05" },
  ],
  teacherPayments: [
    { id: 1, teacherId: 2, amount: 420, month: "January 2025", status: "paid", date: "2025-01-31" },
    { id: 2, teacherId: 3, amount: 360, month: "January 2025", status: "paid", date: "2025-01-31" },
    { id: 3, teacherId: 2, amount: 490, month: "February 2025", status: "unpaid", date: null },
    { id: 4, teacherId: 3, amount: 400, month: "February 2025", status: "unpaid", date: null },
  ],
  books: [
    {
      id: 1, title: "English File B2", level: "B2", author: "Oxford University Press",
      coverColor: "#f97316", description: "Upper-intermediate course book",
      chapters: [
        { id: 1, title: "Unit 1 – A Difficult World", order: 1 },
        { id: 2, title: "Unit 2 – Work & Life Balance", order: 2 },
        { id: 3, title: "Unit 3 – Fact or Fiction?", order: 3 },
        { id: 4, title: "Unit 4 – The Body", order: 4 },
        { id: 5, title: "Unit 5 – Present Continuous", order: 5 },
        { id: 6, title: "Unit 6 – Culture & Identity", order: 6 },
      ],
      assignedGroups: [1],
      fileId: null,
    },
    {
      id: 2, title: "English File A2", level: "A2", author: "Oxford University Press",
      coverColor: "#22c55e", description: "Elementary course book for beginners",
      chapters: [
        { id: 1, title: "Unit 1 – Introductions", order: 1 },
        { id: 2, title: "Unit 2 – Daily Routine", order: 2 },
        { id: 3, title: "Unit 3 – Food & Shopping", order: 3 },
        { id: 4, title: "Unit 4 – Past & Present", order: 4 },
        { id: 5, title: "Unit 5 – Travel & Places", order: 5 },
      ],
      assignedGroups: [2],
      fileId: null,
    },
    {
      id: 3, title: "Advanced English C1", level: "C1", author: "Cambridge University Press",
      coverColor: "#f59e0b", description: "Advanced proficiency preparation",
      chapters: [
        { id: 1, title: "Unit 1 – Critical Thinking", order: 1 },
        { id: 2, title: "Unit 2 – Academic Writing", order: 2 },
        { id: 3, title: "Unit 3 – Rhetoric & Persuasion", order: 3 },
        { id: 4, title: "Unit 4 – Global Issues", order: 4 },
      ],
      assignedGroups: [3],
      fileId: null,
    },
  ],
  // Lessons are attached to sessions via sessionId
  lessons: [
    {
      id: 1, sessionId: null, // applied to sessions in series A
      seriesId: SERIES_A,
      bookId: 1, chapterId: 3, title: "Fact or Fiction – Reading & Discussion",
      description: "Students will read a short article and debate its claims using comparative structures.",
      fileId: null, extraFiles: [],
      homework: "Write a 150-word argument: 'Social media spreads more fiction than fact.' Due next class.",
      homeworkDue: "2025-03-03",
      teacherNotes: "Focus on use of 'however', 'although', 'despite'",
      createdBy: 2,
    },
    {
      id: 2, sessionId: null, seriesId: SERIES_B,
      bookId: 2, chapterId: 2, title: "Daily Routine – Vocabulary Sprint",
      description: "Introduce time expressions and daily routine vocabulary with pair activities.",
      fileId: null, extraFiles: [],
      homework: "Write 5 sentences about your daily routine using the new vocabulary.",
      homeworkDue: "2025-02-28",
      teacherNotes: "Use flashcard activity for first 15 min",
      createdBy: 2,
    },
    {
      id: 3, sessionId: null, seriesId: SERIES_C,
      bookId: 3, chapterId: 2, title: "Academic Writing – Essay Structure",
      description: "Deep dive into introduction, body paragraphs and conclusions.",
      fileId: null, extraFiles: [],
      homework: "Draft an introduction paragraph for the essay topic given in class.",
      homeworkDue: "2025-03-05",
      teacherNotes: "Bring sample essays from previous year for analysis",
      createdBy: 3,
    },
  ],
  gameScores: [],
...
.lp-logo-badge{width:44px;height:44px;border-radius:12px;background:var(--accent);display:flex;align-items:center;justify-content:center;overflow:hidden;box-shadow:0 0 32px rgba(249,115,22,.5)}
...
// ─── FILE UPLOAD WIDGET ───────────────────────────────────────────────────────
function FileUploadWidget({ label, onFileStored, accept = ".pdf,.doc,.docx,.ppt,.pptx,.jpg,.png" }) {
  ...
  return (
    <label className="upload-zone" style={{ display: "block" }}>
      ...
      {uploading
        ? <div className="muted text-sm">Uploading… ⏳</div>
        : <div>
      ...
      <div className="lesson-box">
        ...
        <div className="fg">
          ...
          {form.fileId
            ...
            : <FileUploadWidget label="Upload lesson PDF or slides" onFileStored={handleMainFile} />
          }
        </div>
...
function BooksPage({ data, setData }) {
  ...
  const addBook = () => {
    ...
    const newBook = { ...form, id: Date.now(), chapters: [], fileId: null };
  ...
  const handleBookFile = async (fileId, name) => {
    setData(d => ({ ...d, books: d.books.map(b => b.id === viewBook.id ? { ...b, fileId } : b) }));
    setViewBook(v => v ? { ...v, fileId } : v);
          ...
          <Modal open={!!viewBook} onClose={() => setViewBook(null)} title="Book Details" xl>
            ...
            <div className="mb16">
              ...
              {freshBook.fileId
                ...
                : <FileUploadWidget label="Upload book PDF" onFileStored={handleBookFile} />
              }
            </div>
...
function SessionsPage({ data, setData, userRole, userId }) {
  ...
  // ── HANDLERS ──
  const handleCreateSession = (sessions, seriesMeta) => {
    setData(d => {
  ...
  const markAttendance = (sess, studentId, present) => {
...
function LandingPage({ onGoLogin, onGoSignup }) {
  ...
  const LOGO = "data:image/jpeg;base64,";
  ...
  return (
    <div className="su-wrap">
      ...
      <div className="su-nav">
        <div className="lp-logo-box">
          <div className="lp-logo-badge"><img src="data:image/jpeg;base64," alt="ELOC" style={{ width:"100%", height:"100%", objectFit:"cover" }} /></div>
            ...
            <>
              ...
              <div style={{ display:"flex", gap:10, marginTop:24 }}>
                ...
                {step === 1
                  ...
                  : <button className="btn btn-pr" style={{ flex:1, justifyContent:"center" }} onClick={submit}>🎓 Create My Account</button>
                }
              </div>
            </>
          )}
...
function LoginPage({ onLogin, users, onBack }) {
  ...
  const [email, setEmail] = useState("admin@eloc.com");
  const [password, setPassword] = useState("admin123");
  const [err, setErr] = useState("");

  const demos = {
    admin: { email: "admin@eloc.com", password: "admin123" },
    teacher: { email: "james@eloc.com", password: "teacher123" },
    student: { email: "lucas@eloc.com", password: "student123" },
  };
      ...
      <div className="login-card">
        <div className="card" style={{ padding: 36 }}>
          <div className="login-logo">
            <img src="data:image/jpeg;base64," alt="ELOC" style={{ width: 90, height: 90, objectFit: "contain", margin: "0 auto 10px", display: "block" }} />
          ...
          <button className="btn btn-pr w100" style={{ justifyContent: "center" }} onClick={login}>Sign In →</button>
          <div className="divider" />
          <div style={{ fontSize: 11, color: "var(--text3)", textAlign: "center" }}>Click role tabs above to auto-fill demo credentials</div>
          {onBack && (
            <button
              onClick={onBack}
              style={{
  ...
  return (
    <aside className={`sidebar ${open ? "open" : ""}`}>
      <div className="sidebar-logo">
        <img src="data:image/jpeg;base64," alt="ELOC" style={{ width: 32, height: 32, objectFit: "contain", borderRadius: 6 }} />
...
function PaymentsPage({ data, setData, userRole, userId }) {
  ...
  const [selMonth,  setSelMonth]  = useState("2025-02");    // for monthly picker
  const [selYear,   setSelYear]   = useState("2025");       // for yearly picker
...
function Analytics({ data }) {
  ...
  const [selMonth, setSelMonth] = useState("2025-02");
...
export default function App() {
  ...
  const loadAllData = useCallback(async () => {
    try {
      setApiLoading(true);
      const [users, groups, sessions, series, payments, books, lessons] = await Promise.all([
        api.users.list(),
        api.groups.list(),
        api.sessions.list(),
        api.series.list(),
  ...
  const logout = () => { setUser(null); setPage("dashboard"); setAuthScreen("landing"); };
